...
# Source Files
CORE_SRC  := $(SRC_DIR)/shared_host_core.c $(SRC_DIR)/shared_host_read.c $(SRC_DIR)/shared_host_write.c $(SRC_DIR)/shared_host_claim.c $(SRC_DIR)/shared_host_commit.c $(SRC_DIR)/shm_operations/shm_mapping.c
